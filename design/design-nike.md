...
### Primary
- **Nike Black** (`#111111`): The foundation — primary text, button backgrounds, nav text, hero overlays
- **Nike White** (`#FFFFFF`): Primary page canvas, button text on dark, card surfaces, nav bar background

### Surface & Background
- **Snow** (`#FAFAFA`): Lightest surface, near-white subtle differentiation
- **Light Gray** (`#F5F5F5`): Secondary background, search input fill, image placeholder
...
- **Secondary Text** (`#707072`): Descriptive copy, metadata, timestamps, price labels
...
- **Warning Yellow** (`#FEDF35`): Warning backgrounds, attention banners
