...
### Do
- Use `#76b900` as accent for borders, underlines, and highlights -- never backgrounds
- Apply 2px border radius as the default -- this sharp, engineered look is core to NVIDIA
- Keep headings at weight 700 for maximum authority and impact
- Alternate black and white sections to create visual rhythm
- Use Font Awesome 6 Pro weight 900 for the sharpest icons
- Maintain tight 1.25 line-heights on headings for dense, authoritative text blocks
- Use green-bordered buttons for primary CTAs -- filled only on hover
- Keep typography in NVIDIA-EMEA exclusively -- Arial fallback is for rare edge cases

### Don't
- Never use green as a background fill -- it's a signal color only
- Don't introduce rounded corners (above 2px) -- NVIDIA is sharp and engineered
- Don't use light weights (below 400) -- the voice is always confident and authoritative
- Don't mix mid-tone grays into the UI -- stick to black, white, and green accent
- Don't add decorative shadows or glows -- the system is flat by design
- Don't use serif fonts anywhere -- the system is exclusively geometric sans-serif
- Don't apply gradients to UI elements -- flat solid colors only
- Don't soften the black/white contrast -- the stark duality is essential
...
- Text (light bg): Black (`#000000`) or Near Black (`#1a1a1a`)
