...
import { createBashTools } from './builtin/bash'
import { createFileOpsTools } from './builtin/file-ops'
import { createFsTools } from './builtin/fs-access'
import { createWebTools } from './builtin/web'
import { createTodoTools } from './builtin/todo'
import { createConversationTools } from './builtin/conversation'
import { createMemoryTool } from './builtin/memory'
...
export { createFsTools as createFsToolDefs } from './builtin/fs-access'
...
export { conversationToolDefs } from './builtin/conversation'

// ─── 按模块重新导出工厂函数 ──────────────────────────────────────────────────

export { createBashTools } from './builtin/bash'
export { createFileOpsTools } from './builtin/file-ops'
export { createFsTools } from './builtin/fs-access'
export { createWebTools } from './builtin/web'
export { createTodoTools } from './builtin/todo'
export { createConversationTools } from './builtin/conversation'
export { createMemoryTool } from './builtin/memory'
