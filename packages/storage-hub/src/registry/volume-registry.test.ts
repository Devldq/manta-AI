...
describe('VolumeRegistry', () => {
  ...
  it('treats backslashes as ordinary POSIX characters when checking nesting', () => expect(() => new VolumeRegistry({ ...base(), volumes: [{ ...base().volumes[0], parentPath: '/data\\team' }, { ...base().volumes[0], id: 'v2', parentPath: '/data\\team/manta-ai-data/nested' }] })).toThrow())
