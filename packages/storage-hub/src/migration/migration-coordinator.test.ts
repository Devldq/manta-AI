...
describe('MigrationCoordinator', () => {
  ...
  it.each(['source-present', 'backup-present'] as const)('recovers committed group with %s and repairs both manifests idempotently', async (layout) => {
