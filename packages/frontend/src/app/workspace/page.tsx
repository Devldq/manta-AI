    ...
    <div className="flex h-screen">
      <aside className="w-64 border-r border-border bg-surface p-4">
        ...
        <nav className="space-y-1">
          ...
          <a href="/workspace" className="flex items-center gap-2 px-3 py-2 rounded-md bg-accent-subtle text-accent">
            <FolderOpen size={16} />
            工作空间
          </a>
      ...
      <main className="flex-1 overflow-auto p-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-text-primary mb-6">工作空间</h2>
